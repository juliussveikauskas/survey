        ...
        <div>
            <div className='flex justify-between mb-3'>
                ...
                <div className='flex items-center'>
                    <button type='button' className='flex items-center text-xs py-1 px-3 mr-2 rounded-sm text-white bg-gray-600 hover:bg-gray-700'
                            onClick={() => addQuestion(index + 1)}>
                        <PlusIcon className='w-4' />add
                    </button>
                    <button type="button" className="flex items-center text-xs py-1 px-3 rounded-sm border border-transparent text-red-500 hover:border-red-600 font-semibold"
